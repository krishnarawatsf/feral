...
export const ProductCard = ({ animal, onClick }) => (
  ...
  >
    <div className="relative bg-gradient-to-br from-blue-50 to-sky-50 aspect-[3/4] mb-6 overflow-hidden flex items-center justify-center border border-slate-200">
      ...
      <span className="text-2xl font-light tracking-wider text-slate-700 group-hover:text-blue-900 transition-colors duration-500">{animal.image}</span>
    ...
    <div className="space-y-3">
      ...
      <div className="pt-4 flex items-center justify-between border-t border-slate-200">
        ...
        <button className="text-xs tracking-widest font-sans hover:text-blue-600 transition-colors">
          VIEW DETAILS →
        </button>
      </div>
    </div>
